...
display.grid(column = 0, columnspan = 4, row = 0, ipadx = 20)

button_seven = tk.Button(window, text = "7")
button_seven.grid(column = 0, row = 1, sticky = tk.N+tk.S+tk.E+tk.W)
...
button_plus.grid(column = 3, row = 1, sticky = tk.N+tk.S+tk.E+tk.W)

button_four = tk.Button(window, text = "4")
button_four.grid(column = 0, row = 2, sticky = tk.N+tk.S+tk.E+tk.W)
...
button_minus.grid(column = 3, row = 2, sticky = tk.N+tk.S+tk.E+tk.W)

button_one = tk.Button(window, text = "1")
button_one.grid(column = 0, row = 3, sticky = tk.N+tk.S+tk.E+tk.W)
...
button_times.grid(column = 3, row = 3, sticky = tk.N+tk.S+tk.E+tk.W)

button__ = tk.Label(window)
button__.grid(column = 0, row = 4, sticky = tk.N+tk.S+tk.E+tk.W)
...
button_slash.grid(column = 3, row = 4, sticky = tk.N+tk.S+tk.E+tk.W)

button_equals = tk.Button(window, text = "=")
button_equals.grid(column = 3, row = 5, sticky = tk.N+tk.S+tk.E+tk.W)

button_clear = tk.Button(window, text = "Clear")
button_clear.grid(column = 1, columnspan = 2, row = 6, sticky = tk.N+tk.S+tk.E+tk.W)
